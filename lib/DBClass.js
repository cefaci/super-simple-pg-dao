...
export default class DBClass {
   ...
   * @param {*} data 
   */
  prepareUpdate(data = {}, default_value = true){
    return Preparation.update_object(this._table, data, default_value)
  }
   ...
   */
  async delete(data){
    let options = Preparation.update_object(this._table, data, 'delete', true)
    // console.log('delete', options)
    return await DB.queryTx(DB.delete, options, options.values) 
  }
